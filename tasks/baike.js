    ...
    setTimeout(async () => {
      const meta = await page.evaluate(async ()=>{
        ...
        try {
          ...
          document.querySelector('.lemmaWgt-searchHeader').remove();
          document.querySelector('.header-wrapper').remove();
          document.querySelector('.navbar-wrapper').remove();
          document.querySelector('.before-content').remove();
          document.querySelector('.side-content').remove();
          document.querySelector('.top-tool').remove();
          document.querySelector('.new-bdsharebuttonbox').remove();
          document.querySelector('.tashuo-bottom').remove();
          document.querySelector('.after-content').remove();
          document.querySelector('.wgt-footer-main').remove();
